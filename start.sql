...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 06 2022 г., 19:35
...
(273, 1, '0c5aa75e0094ffd005b1d9b9cd', '127.0.0.1', '2022-02-06 15:28:31', '2022-02-06 15:28:31'),
...
(5, 0, 'INV-2022-00', 0, 'Интернет магазин всякой фигни', 'http://start.local/', 0, 1, 'Александр Львович', '', '', '+7 (987) - 668 - 04 - 84', '', '[]', 'Александр Львович', '', '', 'Чебоксары Николаева 42-37', '', '', '', 'Российская Федерация', 176, '', 0, '', '[]', 'Оплата при доставке', 'cod', 'Александр Львович', '', '', 'Чебоксары Николаева 42-37', '', '', '', 'Российская Федерация', 176, '', 0, '', '[]', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', 'коментарий', '9918.0000', 2, 0, '0.0000', 0, '', 1, 1, 'RUB', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.99 Safari/537.36', 'ru-RU,ru;q=0.9,en-US;q=0.8,en;q=0.7', '2022-02-06 15:27:51', '2022-02-06 15:28:07');
...
(5, 5, 43, 'MacBook', 'Product 16', 2, '4809.0000', '9618.0000', '18.0000', 1200);
...
(13, 5, 'sub_total', 'Сумма', '9618.0000', 1),
(14, 5, 'shipping', 'Доставка с фиксированной стоимостью доставки', '300.0000', 3),
(15, 5, 'total', 'Итого', '9918.0000', 9);
...
(30, 'Product 3', '', '', '', '', '', '', '', 7, 6, 'catalog/demo/canon_eos_5d_1.jpg', 9, 1, '100.0000', 0, 9, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 14, '2009-02-03 16:59:00', '2011-09-30 01:05:23'),
...
(40, 'product 11', '', '', '', '', '', '', '', 966, 5, 'catalog/demo/iphone_1.jpg', 8, 1, '1101.0000', 0, 9, '2009-02-03', '10.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 17, '2009-02-03 21:07:12', '2022-01-30 14:17:59'),
...
(43, 'Product 16', '', '', '', '', '', '', '', 923, 7, 'catalog/demo/macbook_1.jpg', 8, 1, '5000.0000', 0, 9, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, 73, '2009-02-03 21:07:49', '2022-01-30 14:33:22'),
...
--
ALTER TABLE `oc_api_session`
  MODIFY `api_session_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=274;
...
--
ALTER TABLE `oc_cart`
  MODIFY `cart_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=240;
...
--
ALTER TABLE `oc_order_total`
  MODIFY `order_total_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `oc_product_image`
  MODIFY `product_image_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2430;
...
--
ALTER TABLE `oc_product_reward`
  MODIFY `product_reward_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=562;

--
-- AUTO_INCREMENT для таблицы `oc_product_special`
--
ALTER TABLE `oc_product_special`
  MODIFY `product_special_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=456;
...
--
ALTER TABLE `oc_seo_url`
  MODIFY `seo_url_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=910;
...
--
ALTER TABLE `oc_theme`
  MODIFY `theme_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=499;
